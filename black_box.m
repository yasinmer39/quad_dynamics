...
meas_pqr = [ang_vel_meas.xyz(:,1) ang_vel_meas.xyz(:,2) ang_vel_meas.xyz(:,3) ang_vel_meas.xyz_derivative(:,1) ang_vel_meas.xyz_derivative(:,2) ang_vel_meas.xyz_derivative(:,3)];
...
TT_meas = array2timetable(meas_pqr,'RowTimes',t_meas,'VariableNames',{'p_meas','q_meas','r_meas','pdot_meas','qdot_meas','rdot_meas'});
